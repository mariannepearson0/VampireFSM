...
package object controllers {
  ...
  object FieldMappings {
    ...
    def postcode: Mapping[String] =
      text(maxLength = 8) verifying nonEmptyPostcodeConstraint
    def telephoneNumber: Mapping[Option[String]] =
      optional(text(maxLength = 24) verifying telephoneNumberConstraint)
    def validName: Mapping[String] =
      text(maxLength = 56) verifying (validNameConstraint)
    ...
    private val nonEmptyPostcodeConstraint: Constraint[String] =
    ...
    private val telephoneNumberConstraint: Constraint[String] =
      Constraint[String] { fieldValue: String =>
        Constraints.nonEmpty(fieldValue) match {
          case i: Invalid => i
          case Valid =>
    ...
    private val validNameConstraint: Constraint[String] = Constraint[String] {
      fieldValue: String =>
        Constraints.nonEmpty(fieldValue) match {
          case i @ Invalid(_) =>
            i
